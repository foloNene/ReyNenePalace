...
namespace ReyNenePalace.Migrations
{
    ...
    [Migration("20211230024951_IdentityAdded1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReyNenePalace.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("ReyNenePalace.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ReyNenePalace.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("ReyNenePalace.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ReyNenePalace.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("ReyNenePalace.Models.OrderDetail", b =>
                {
                    b.HasOne("ReyNenePalace.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReyNenePalace.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ReyNenePalace.Models.Pie", b =>
                {
                    b.HasOne("ReyNenePalace.Models.Category", "Category")
                        .WithMany("Pies")
